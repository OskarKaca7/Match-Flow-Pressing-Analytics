...
""", unsafe_allow_html=True)
    ...
    st.divider()
    st.caption("Data provided by **StatsBomb Open Data**. Visualization designed for educational purposes.").zones-bar { display: flex; height: 12px; border-radius: 6px; overflow: hidden; background: #eee; }
